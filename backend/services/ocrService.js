      ...
      "memos": [
        {
          ...
          "เอกสารข้อมูลเพิ่มเติม": "ระบุเฉพาะข้อมูลที่อยู่หลังคำว่า 'สิ่งที่ส่งมาด้วย' หรือ 'เอกสารแนบ' ที่ระบุไว้ชัดเจนในส่วนหัวของเอกสารเท่านั้น (เช่น 'สำเนาหนังสือ สน.บางนา 1 ฉบับ') ห้ามดึงข้อความจากการอ้างถึงในเนื้อหามาใส่เด็ดขาด และถ้าเจอข้อความตัวเลขลอยๆ เช่น 'เอกสาร ๑', 'เอกสาร ๑-๓' หรือไม่มีหัวข้อสิ่งที่ส่งมาด้วย ให้ใส่ null เท่านั้น",
